...
using AdventureWorks.Data.dbo;
using AdventureWorks.Data.HumanResources;
using AdventureWorks.Data.Person;
using AdventureWorks.Data.Production;
using AdventureWorks.Data.Purchasing;
using AdventureWorks.Data.Sales;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.ChangeTracking;
using Microsoft.EntityFrameworkCore.Infrastructure;
using Microsoft.EntityFrameworkCore.Metadata;
using Culture = AdventureWorks.Data.Sales.Culture;
...
namespace AdventureWorks.Data
{
    public interface IAdventureWorks2014Context
    {
        ...
        DbSet<Person.Person> Person { get; set; }
    ...
    public partial class AdventureWorks2014Context : DbContext, IAdventureWorks2014Context
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalesOrderHeader>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.TotalDue, e.CustomerId, e.SalesOrderId })
                    .HasName("IDX_ForPerformanceDemo");
